-- Name: desk_com_connector.get_list_site_settings
-- Created: 2015-08-10 15:23:31

CREATE virtual procedure desk_com_connector.get_list_site_settings ( IN in_since_id integer ) RETURNS ( "id" integer, "name" string, "value" string, "total_entries" string, "page" string ) as
begin
