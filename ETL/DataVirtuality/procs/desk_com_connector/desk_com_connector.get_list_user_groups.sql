-- Name: desk_com_connector.get_list_user_groups
-- Created: 2015-08-10 15:23:35

CREATE virtual procedure desk_com_connector.get_list_user_groups ( IN in_since_id integer, in in_user_id string ) RETURNS ( "id" integer, "name" string, "total_entries" string, "page" string ) as
begin
