-- Name: desk_com_connector.get_list_labels
-- Created: 2015-08-10 15:23:28

CREATE virtual procedure desk_com_connector.get_list_labels ( IN in_since_id integer ) RETURNS ( "id" integer, "name" string, "types" string, "description" string, "enabled" string, "color" string, "total_entries" string, "page" string ) as
begin
