-- Name: desk_com_connector.get_list_group_permissions
-- Created: 2015-08-10 15:23:27

CREATE virtual procedure desk_com_connector.get_list_group_permissions ( IN in_since_id integer, in in_group_id string ) RETURNS ( "name" string, "total_entries" string, "page" string ) as
begin
