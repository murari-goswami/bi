-- Name: desk_com_connector.get_list_case_notes
-- Created: 2015-08-10 15:23:48

CREATE virtual procedure desk_com_connector.get_list_case_notes ( in in_case_id string, IN in_since_id integer ) RETURNS ( "id" integer, "body" string, "created_at" timestamp, "updated_at" timestamp, "erased_at" timestamp, "total_entries" string, "page" string ) as
begin
