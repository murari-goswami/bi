-- Name: desk_com_connector.get_list_group_filters
-- Created: 2015-08-10 15:23:49

CREATE virtual procedure desk_com_connector.get_list_group_filters ( in in_since_id integer, in in_group_id string ) RETURNS ( "name" string, "sort_field" string, "sort_direction" string, "position" string, "active" string, "total_entries" string, "page" string ) as
begin
