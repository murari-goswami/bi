-- Name: desk_com_connector.get_list_twitter_users
-- Created: 2015-08-10 15:23:45

CREATE virtual procedure desk_com_connector.get_list_twitter_users ( IN in_since_id integer ) RETURNS ( "id" integer, "followers_count" string, "verified" string, "created_at" timestamp, "updated_at" timestamp, "handle" string, "image_url" string, "total_entries" string, "page" string ) as
begin
