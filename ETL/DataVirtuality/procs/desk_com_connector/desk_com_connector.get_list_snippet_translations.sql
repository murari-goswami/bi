-- Name: desk_com_connector.get_list_snippet_translations
-- Created: 2015-08-10 15:23:56

CREATE virtual procedure desk_com_connector.get_list_snippet_translations ( IN in_since_id integer, in in_snippet_id string ) RETURNS ( "id" integer, "locale" string, "text" string, "total_entries" string, "page" string ) as
begin
