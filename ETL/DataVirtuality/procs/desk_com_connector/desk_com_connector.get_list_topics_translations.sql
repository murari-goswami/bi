-- Name: desk_com_connector.get_list_topics_translations
-- Created: 2015-08-10 15:23:44

CREATE virtual procedure desk_com_connector.get_list_topics_translations ( IN in_since_id integer, in in_topic_id string ) RETURNS ( "id" integer, "name" string, "locale" string, "created_at" timestamp, "updated_at" timestamp, "total_entries" string, "page" string ) as
begin
