-- Name: desk_com_connector.get_list_rules
-- Created: 2015-08-10 15:23:43

CREATE virtual procedure desk_com_connector.get_list_rules ( IN in_since_id integer ) RETURNS ( "id" integer, "name" string, "description" string, "created_at" timestamp, "updated_at" timestamp, "enabled" string, "total_entries" string, "page" string ) as
begin
