-- Name: desk_com_connector.get_list_brands
-- Created: 2015-08-10 15:23:48

CREATE virtual procedure desk_com_connector.get_list_brands ( IN in_since_id integer ) RETURNS ( "id" integer, "total_entries" string, "page" string, "name" string, "created_at" timestamp, "updated_at" timestamp ) as
begin
