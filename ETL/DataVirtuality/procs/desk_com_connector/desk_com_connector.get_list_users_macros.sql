-- Name: desk_com_connector.get_list_users_macros
-- Created: 2015-08-10 15:23:34

CREATE virtual procedure desk_com_connector.get_list_users_macros ( IN in_since_id integer, in in_user_id string ) RETURNS ( "id" integer, "name" string, "description" string, "position" string, "enabled" string, "folders" string, "total_entries" string, "page" string ) as
begin
