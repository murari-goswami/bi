-- Name: desk_com_connector.get_list_facebook_feeds
-- Created: 2015-08-10 15:23:39

CREATE virtual procedure desk_com_connector.get_list_facebook_feeds ( IN in_since_id integer ) RETURNS ( "id" integer, "image_url" string, "profile_url" string, "created_at" timestamp, "updated_at" timestamp, "total_entries" string, "page" string ) as
begin
