-- Name: desk_com_connector.get_list_jobs
-- Created: 2015-08-10 15:23:41

CREATE virtual procedure desk_com_connector.get_list_jobs ( IN in_since_id integer ) RETURNS ( "id" integer, "type" string, "status_message" string, "progress" string, "created_at" timestamp, "completed_at" timestamp, "last_error" string, "total_entries" string, "page" string ) as
begin
