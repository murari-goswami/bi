-- Name: desk_com_connector.get_list_user_searches
-- Created: 2015-08-10 15:23:46

CREATE virtual procedure desk_com_connector.get_list_user_searches ( IN in_since_id integer, in in_user_id string ) RETURNS ( "id" integer, "name" string, "query" string, "created_at" timestamp, "updated_at" timestamp, "search_object" string, "total_entries" string, "page" string ) as
begin
