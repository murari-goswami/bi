-- Name: tableau.ops_booked_without_return
-- Created: 2015-06-17 15:43:49
-- Updated: 2015-09-28 17:31:08

CREATE VIEW tableau.ops_booked_without_return AS WITH dataset7 as (
    WITH dataset6 as (
        WITH dataset5 as (
            WITH dataset3 as (
                WITH dataset2 as (
